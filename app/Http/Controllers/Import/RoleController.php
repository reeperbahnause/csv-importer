...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $columns  = RoleService::getColumns($content, $configuration->isHeaders());
        ...
        return view('import.roles.index', compact('mainTitle', 'subTitle', 'columns', 'examples', 'roles', 'configuredRoles'));
    }
